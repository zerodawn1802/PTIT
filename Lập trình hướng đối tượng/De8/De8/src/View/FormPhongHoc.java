...
public class FormPhongHoc extends javax.swing.JPanel {
    ...
    String fphong = "src/Controller/Phong.DAT";
    List<PhongHoc> lphong;

    public FormPhongHoc() {
        initComponents();
        String[] col = {"ma phong", "ten phong", "so ghe", "loai phong"};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (lphong.size() > 0) {
            PhongHoc.setSmaphong(lphong.get(lphong.size() - 1).getMaphong() + 1);
        } else {
            lphong = new ArrayList<>();
        }
        jTextField1.setText(PhongHoc.getSmaphong() + "");
        jTextField2.requestFocus();

        try {
            String tp = jTextField2.getText();
            String sg = jTextField3.getText();
            if (tp.isEmpty() || sg.isEmpty()) {
                throw new TrongEX();
            }
            ...
            PhongHoc p = new PhongHoc(Integer.parseInt(jTextField1.getText()), tp, jComboBox1.getSelectedItem().toString(), soghe);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (f.exists()) {
            ...
            tm.setRowCount(0);
            for (PhongHoc i : lphong) {
                if(i.getTenphong().toLowerCase().contains(jTextField4.getText().toLowerCase()) || i.getKieuphong().toLowerCase().contains(jTextField4.getText().toLowerCase())) {
                    tm.addRow(i.toObjects());
                }
            }
        } else lphong = new ArrayList<>();
